      ...
      <div className="p-5 pl-6 flex flex-col gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="flex items-center gap-1.5 ml-auto">
            ...
            {isHot && (
              <span className="px-2 py-0.5 rounded-full bg-[var(--color-warning)]/10 text-[var(--color-warning)] text-[8px] font-black uppercase tracking-wider border border-[var(--color-warning)]/30 flex items-center gap-1">
