...
export default function CareerPage() {
  ...
  const nextOpponent = nextFixture
    ...
    : "No fixture";
  const checkingOperation = [advance, nextSeason, acceptManagerJob, submitOffer, completeTransfer]
    .some((operation) => operation.operationPhase === "checking");
  ...
  return <SportsShell game><div className="career-workspace">
    ...
    {checkingOperation && <section className="card px-4 py-3" role="status" aria-live="polite">
      <p className="eyebrow">Checking operation status…</p>
      <span className="text-sm text-slate-300">The command is locked while Career confirms whether it completed.</span>
    </section>}
