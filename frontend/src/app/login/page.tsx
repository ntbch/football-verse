      ...
      <div className="w-full max-w-6xl bg-white border border-[var(--color-border)] rounded-3xl overflow-hidden shadow-2xl grid grid-cols-1 md:grid-cols-2 min-h-[650px] transform transition-all duration-300">
        ...
        <div className="p-8 md:p-14 flex flex-col justify-between h-full bg-[#faf9f6]">
          <div>
            ...
            <div className="mb-10">
              <h2 className="font-serif font-black text-4xl text-[var(--color-text-primary)] tracking-tight mb-3">
                Welcome Back
              </h2>
            ...
            <form onSubmit={handleLogin} className="flex flex-col gap-6">
              ...
              {error && (
                <div className="p-3.5 bg-red-50 border border-red-200 rounded-xl flex items-center gap-2">
                  ...
                  <p className="text-xs font-semibold text-red-700 m-0">{error}</p>
                </div>
              )}
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full btn btn-primary !rounded-xl !py-4 !text-xs active:scale-[0.98] transition-all"
              >
            ...
            <button
              ...
              onClick={() => {
                if ((window as any).google?.accounts?.id) {
                  ...
                  setError("Google Sign-In is not configured. Please set GOOGLE_CLIENT_ID.");
                }
              }}
          ...
          <div className="mt-10 pt-6 border-t border-[var(--color-border)] flex items-center justify-between text-xs text-[var(--color-text-secondary)] font-medium">
